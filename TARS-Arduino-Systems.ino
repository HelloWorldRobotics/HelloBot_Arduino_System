...
VarSpeedServo myservo_left_small;//left small servo
VarSpeedServo myservo_right_small;//right small servo
VarSpeedServo myservo_left_big;//left big servo
VarSpeedServo myservo_right_big;//right big servo
int servo_speed = 30;
int left_small_servo_pin = 9; 
int right_small_servo_pin = 8; 
int left_big_servo_pin = 11; 
int right_big_servo_pin = 10;
...
int step_counts = 0;    
int microstep   = 6400; // default:6400
int stop_flag   = 0;
...
//Lid Opening Part
void servo_init_position(){
  myservo_left_small.write(90, servo_speed);     
  myservo_right_small.write(90, servo_speed);
  myservo_left_big.write(90, servo_speed);     
  myservo_right_big.write(90, servo_speed);
}
void servo_wait(){
  myservo_left_small.wait();     
  myservo_right_small.wait();
  myservo_left_big.wait();     
  myservo_right_big.wait();  
}
//Lid Opening Part
...
void setup() {
  ...
  //Lid Opening Part
  myservo_left_small.attach(left_small_servo_pin);
  myservo_right_small.attach(right_small_servo_pin);
  myservo_left_big.attach(left_big_servo_pin);
  myservo_right_big.attach(right_big_servo_pin);
...
void lid_opening(){
  myservo_left_small.write(160, servo_speed);     
  myservo_right_small.write(20, servo_speed);
  myservo_left_big.write(50, servo_speed);     
  myservo_right_big.write(130, servo_speed);
  servo_wait();
  delay(1000);
  myservo_left_big.write(0, servo_speed);     
  myservo_right_big.write(180, servo_speed);
  servo_wait();;  
  delay(1000);
}
